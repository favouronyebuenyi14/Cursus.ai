...
import {
  ArrowLeft, Download, Lock, Share2, Sparkles, Wand2, Mic, Square, Loader2
} from 'lucide-react'
  ...
  async function toggleRecording() {
    ...
    try {
      ...
      recorder.onstop = async () => {
        ...
        formData.append('duration_seconds', recordingTimeRef.current.toString())
    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 text-[#2c2f31]">
      <div className="flex flex-col gap-4 rounded-[28px] bg-white p-5 shadow-sm md:flex-row md:items-center md:justify-between md:p-6">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          {transcribing ? (
            <div className="inline-flex h-11 items-center gap-2 rounded-xl border border-amber-200 bg-amber-50 px-4 text-sm font-semibold text-amber-700">
            ...
            <button
              ...
              className={`inline-flex h-11 items-center gap-2 rounded-xl border px-4 text-sm font-semibold transition-colors ${
                isRecording 
                  ...
                  : 'border-slate-200 text-[#595c5e] hover:bg-slate-50 hover:text-[#006094]'
              }`}
            >
        ...
        >
          ...
          >
            ...
            <p className="mb-6 text-sm text-[#595c5e]">
              You have reached your recording limit or are trying to use an AI feature reserved for Pro users. Upgrade to Pro for unlimited access.
            </p>
